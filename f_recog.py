...
# UNKNOW_FACES_DIR = "unknown_faces"
...
#                     f'{KNOW_FACES_DIR}/{name}/{filename}')
#                 print(f'Working on {KNOW_FACES_DIR}/{name}/{filename}')
#                 encoding = face_recognition.face_encodings(image)[0]
#                 known_faces.append(encoding)
#                 known_names.append(name)

# print('Loading unkown faces from the files...')
...
#     print(len(encoding), len(locations))
#     for face_encoding, face_locations in zip(encoding, locations):
#         print(
#             f'Comparing faces for {encoding}->{locations} => TOLERANCE: {TOLERANCE}')
...
#             cv2.putText(
#                 image, match, (face_location[3] + 10, face_location[2] + 15), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (200, 200, 200), FONT_THICKNESS)
...
for name in os.listdir(KNOWN_FACES_DIR):
    ...
    for filename in os.listdir(f'{KNOWN_FACES_DIR}/{name}'):
        ...
        print(f'known {KNOWN_FACES_DIR}/{name}/{filename} loaded...')
...
for filename in os.listdir(UNKNOWN_FACES_DIR):
    ...
    print(f'{UNKNOWN_FACES_DIR}/{filename} loaded...')
